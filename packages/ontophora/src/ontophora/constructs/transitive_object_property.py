...
class TransitiveObjectProperty(BaseConstruct):
    """States that an object property is transitive.

    See: [OWL 2 reference](https://www.w3.org/TR/owl2-syntax/#Transitive_Object_Properties)
    """
    ...
    kind: Literal["TransitiveObjectProperty"] = "TransitiveObjectProperty"
