...
class NegativeObjectPropertyAssertion(BaseConstruct):
    """States that an object property does not relate two individuals.

    See: [OWL 2 reference](https://www.w3.org/TR/owl2-syntax/#Negative_Object_Property_Assertions)
    """
    ...
    kind: Literal["NegativeObjectPropertyAssertion"] = "NegativeObjectPropertyAssertion"
