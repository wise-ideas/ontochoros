...
class DisjointDataProperties(BaseConstruct):
    """States that listed data properties are pairwise disjoint.

    See: [OWL 2 reference](https://www.w3.org/TR/owl2-syntax/#Disjoint_Data_Properties)
    """
    ...
    kind: Literal["DisjointDataProperties"] = "DisjointDataProperties"
